  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          green: "oklch(0.42 0.13 142)",
          "green-dark": "oklch(0.35 0.12 142)",
          "green-footer": "oklch(0.32 0.10 142)",
          "green-light": "oklch(0.93 0.04 142)",
          orange: "oklch(0.75 0.16 65)",
          "orange-dark": "oklch(0.65 0.15 65)",
          cream: "oklch(0.955 0.025 85)",
        },
      },
